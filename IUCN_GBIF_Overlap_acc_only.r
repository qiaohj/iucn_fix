...
if (i==4){
  ...
  folder<-"../../Data/IUCN_Distribution_Lines/Odonata_With_Boundary"
...
if (i==1){
  ...
  folder<-"../../Data/IUCN_Distribution_Lines/Amphibians_With_Boundary"
  GBIF_Folder<-"../../Data/GBIF_More_Data/Amphibians"
  IUCN_List<-list.files(folder)
  realm_ids<-read.table("../../Tables/Realm/Realm_IDs.csv", head=T, sep=",", stringsAsFactors = F)
...
if (i==5){
  ...
  folder<-"../../Data/IUCN_Distribution_Lines/Reptiles_With_Boundary"
  GBIF_Folder<-"../../Data/GBIF_More_Data/Reptiles"
  IUCN_List<-list.files(folder)
  realm_ids<-read.table("../../Tables/Realm/Realm_IDs.csv", head=T, sep=",", stringsAsFactors = F)
